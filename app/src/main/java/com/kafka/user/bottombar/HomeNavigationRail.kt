...
import com.kafka.user.bottombar.HomeNavigationRailDefaults.ExpandedPlaybackControlsMinWidth
import com.kafka.user.bottombar.HomeNavigationRailDefaults.ExpandedPlaybackModeMinHeight
                ...
                if (isExpandedPlaybackControls) {
                    ...
                    AnimatedVisibility(
                        ...
                        PlaybackArtworkPagerWithNowPlayingAndControls(
                            ...
                            onArtworkClick = {
                                navigator.navigate(
                                    LeafScreen.PlayerLibrary().createRoute()
                                )
                            },
                    ...
                    MiniPlayer(
                        modifier = Modifier
                            ...
                            .zIndex(2f),
                        openPlaybackSheet = { navigator.navigate(RootScreen.PlayerLibrary.route) }
                    )
                }
            }
        }
