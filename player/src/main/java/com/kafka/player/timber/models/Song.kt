 ...
 *
 */
package com.kafka.player.timber.models
...
import com.kafka.player.timber.Utils.getAlbumArtUri
import com.kafka.player.timber.extensions.value
import com.kafka.player.timber.extensions.valueOrDefault
import com.kafka.player.timber.extensions.valueOrEmpty
import com.kafka.player.timber.playback.TimberMusicService.Companion.TYPE_SONG
...
data class Song constructor(
    ...
    var albumId: Long = 0,
    var artistId: Long = 0,
    var title: String = "Ibn-e-maryam hua kare koi",
