...
object ElementStyleParser {
    fun parseTextWithStyle(
        ...
        return when {
            element.isHeadingStyle() -> createHeadingText(text, element)
            else -> createStyledText(text, element, inlineElements)
        }
    }
    ...
    private fun createHeadingText(text: String, element: Element): ContentElement.Text {
