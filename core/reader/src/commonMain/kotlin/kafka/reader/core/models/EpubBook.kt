...
data class EpubBook @OptIn(ExperimentalSerializationApi::class) constructor(
    ...
    @ProtoNumber(7) val navPoints: List<NavPoint> = emptyList(),
    @ProtoNumber(8) val coverImage: EpubImage? = null,
    @ProtoNumber(9) val images: List<EpubImage> = emptyList(),
    @ProtoNumber(10) val lastSeenPage: Int = 0,
    @ProtoNumber(11) val lastPageOffset: Int = 0,
)
