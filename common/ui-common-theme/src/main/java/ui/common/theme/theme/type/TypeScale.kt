...
internal object TypeScale {
    ...
    val BodyLargeWeight = Typeface.WeightMedium
    val BodyMediumFont = FontFamily.Serif
    val BodyMediumLineHeight = 20.0.sp
    val BodyMediumSize = 13.sp
    val BodyMediumTracking = 0.2.sp
    val BodyMediumWeight = FontWeight.SemiBold
    ...
    val DisplayMediumFont = Lora
    val DisplayMediumLineHeight = 52.0.sp
    val DisplayMediumSize = 45.sp
    val DisplayMediumTracking = 0.0.sp
    val DisplayMediumWeight = Typeface.WeightBold
    val DisplaySmallFont = Inter
    val DisplaySmallLineHeight = 44.0.sp
    val DisplaySmallSize = 24.sp
    val DisplaySmallTracking = 0.0.sp
    val DisplaySmallWeight = Typeface.WeightBold
    val HeadlineLargeFont = Typeface.BrandRegular
    val HeadlineLargeLineHeight = 40.0.sp
    val HeadlineLargeSize = 32.sp
    val HeadlineLargeTracking = 0.0.sp
    val HeadlineLargeWeight = FontWeight.SemiBold
    val HeadlineMediumFont = Lora
